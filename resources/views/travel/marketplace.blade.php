@extends('travel.layouts.base', ['collaboration' => true])
...
<section class="container pt-5">
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center pt-1 border-bottom pb-4 mb-4">
        ...
        <div class="pt-3"><a class="btn btn-outline-accent btn-sm" href="{{ route("section.shop-grid", ['section' => $section->slug]) }}">Más productos<i class="czi-arrow-right ml-1 mr-n1"></i></a></div>
    </div>
    <!-- Grid-->

                        ...
                        <div class="widget pb-2 mb-2">
                            ...
                            <div class="d-flex flex-wrap">
                                ...
                                <div class="col-md-6 mx-auto mb-2 text-center">
                                    <img class="img-fluid" style="width:60%" src="{{ asset('img/prolibro/logo-municipalidad.jpg') }}" />
                                </div>
            ...
            <div class="row pb-2">
                ...
                <div class="col-md-6 text-center text-md-right mb-4">
                    <div class="mb-3">
                        ...
                        <a class="social-btn sb-light sb-facebook ml-2 mb-2" href="https://www.facebook.com/Prolibro.cl" target="_blank"><i class="czi-facebook"></i></a>
                        ...
                        <a class="social-btn sb-light sb-instagram ml-2 mb-2" href="https://www.instagram.com/prolibro/" target="_blank"><i class="czi-instagram" target="_blank"></i></a>
                        <a class="social-btn sb-light sb-linkedin ml-2 mb-2" href="https://www.linkedin.com/company/prolibro/?viewAsMember=true" target="_blank"><i class="czi-linkedin" target="_blank"></i></a>
